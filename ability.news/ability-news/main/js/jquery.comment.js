(function($){
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='60' rows='5' placeholder='Say something' class='mytextarea' ></textarea><span class='send'>Send</span></div>")
		.find(".send").click(function(){
			...
			if(content != ""){
				...
				$(".replybox").remove();
				parentEl.find(".reply-list").append(replyString).find(".reply-list-btn:last").click(function(){alert("You can't reply yourself");});
			}else{
				alert("empty content");
			}
		});
