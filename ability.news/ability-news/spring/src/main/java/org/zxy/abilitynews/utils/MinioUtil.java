package org.zxy.abilitynews.utils;
...
public class MinioUtil {
     ...
     * -----------------------------------------------------
     */
    public CommonResult uploadFile(MultipartFile multipartFile, String fileName) throws Exception {
     ...
     * -----------------------------------------------------
     */
    public CommonResult delFile(String delFileName) throws Exception {
//        // 使用MinIO服务的URL，端口，Access key和Secret key创建一个MinioClient对象
        MinioClient minioClient = new MinioClient(minioUrl, username, password);
